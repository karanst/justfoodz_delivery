...
final String appName = 'JustFoodz - Delivery Boy';
...
const String PWD_LENGTH = 'password should be more then 7 char long';
...
// final String baseUrl = 'https://entemarket.com/delivery_boy/app/v1/api/';
final String baseUrl = 'https://alphawizztest.tk/justfoodz/delivery_boy/app/v1/api/';
