...
final Uri getMoneyApi =Uri.parse( baseUrl + 'get_earning_data');
final Uri getUserApi = Uri.parse(baseUrl + 'get_user_data');
final Uri getEarningApi = Uri.parse(baseUrl + 'get_earn_amount');
final Uri getUpdateApi = Uri.parse(baseUrl + 'update_fuid');
final Uri updateStatusApi = Uri.parse(baseUrl + 'onoffdriver');
final Uri addNoteApi = Uri.parse(baseUrl + 'get_send_Mesage');
...
final Uri updateOrderStatusApi = Uri.parse(baseUrl + 'updat_order_status');
...
const String STORE_LATITUDE = 'sellerlatitude';
const String STORE_LONGITUDE = 'sellerlongitude';
