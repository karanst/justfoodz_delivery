...
class Order_Model {
  String? id,
      ...
      sellerlatitude,sellerlogtitude,timeData,earning,selleraddres,sellerMobile,useraddress,sellername,sellerfcm,selleremail,sellerfuid;
  ...
  factory Order_Model.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return Order_Model(
        ...
        useraddress: parsedJson["address"],
        selleraddres: parsedJson["selleraddres"],
        sellerMobile: parsedJson['seller_mobile'],
        orderDate: date,
        itemList: itemList,
        listStatus: lStatus,
        listDate: lDate,
