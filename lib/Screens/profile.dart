...
import 'package:entemarket_delivery/NewScreen/change_password_screen.dart';
...
class StateProfile extends State<Profile> with TickerProviderStateMixin {
  ...
  getUserDetails() async {
    ...
    address1 = await getPrefrence(ADDRESS);
                            ...
                            child: Card(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    //_getDivider(),
                                    setMobileNo(),
                                    setShow("Address", address.toString(),Icons.location_on_outlined),
                                    _getDivider(),
                                    setShow("Bank Name", bankName.toString(),Icons.food_bank_outlined),
                                    setShow("Holder Name", accountName.toString(),Icons.person_outline),
                                    setShow("Account Number", accountNumber.toString(),Icons.confirmation_num_outlined),
                                    setShow("IFSC Code", ifscCode.toString(),Icons.code),
