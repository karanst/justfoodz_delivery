                    ...
                    child: Column(
                      children: [
                        ...
                        model.delDate != null && model.delDate!.isNotEmpty
                            ...
                            : Container(),
                        updateStat(model.itemList![0], model),
                        ListView.builder(
                          shrinkWrap: true,
...
/*    if (await canLaunch(url)) {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Text(capitalize(widget.model!.selleraddres.toString()),
                          ...
                          InkWell(
                              child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(" ${widget.model!.sellerMobile.toString()}",
                                          style: const TextStyle(
                                              color: fontColor,
                                              decoration: TextDecoration.underline)),
                                    ],
                              ...
                              onTap: (){
                                _launchCaller(widget.model!.sellerMobile!);
                              }
                          ),
                        ],
                      ))
  ...
  Widget updateStat(OrderItem orderItem, Order_Model model){
    return
                  ...
                  child: DropdownButtonFormField(
                    ...
                    statusList.map((String st) {
                      return DropdownMenuItem<String>(
                        value: st,
                        child: Text(
                          st=="processed"?"Accepted":capitalize(st),
                          style: Theme.of(context)
                              .textTheme
                              .subtitle2!
                              .copyWith(
  ...
  Future<void> updateOrder(
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("this is param @@ $parameter");
        // if (item) parameter[ORDERITEMID] = widget.model!.itemList![index].id;

        print(parameter.toString());
        Response response =
        await post(updateOrderStatusApi, body: parameter, headers: headers)
            .timeout(Duration(seconds: timeOut));
print("this is url $updateOrderStatusApi");
